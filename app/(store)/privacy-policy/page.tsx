  ...
  return (
    <main className="container flex flex-col justify-start items-center p-5 gap-5  min-h-[90dvh]">
      ...
      <p className="text-center mt-5">
        This Privacy Policy governs the manner in which ahandymaninnewcastle.co.uk collects, uses, maintains and discloses information collected from users (each, a "User") of the https://www.ahandymaninnewcastle.co.uk website ("Site").
      </p>
