...
export default function Home() {
  return (
    <main className="container p-5">
      ...
      <section className={cn(bannerVariants({ variant: "center", size: "threeQuarters", className: "flex-col items-stretch gap-10 pt-10 sm:pt-25" }))}>
      ...
      <section className={cn(bannerVariants({ variant: "center", size: "full", className: "flex-col items-stretch gap-5" }))}>
